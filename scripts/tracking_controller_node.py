...
class UnifiedPlumeTrackerNode:
    def __init__(self):
        ...
        self.surge_agent = SurgeCastAgent(
            ...
            tau_surge=2.0,       # INCREASED surge time constant for longer surges
            cast_freq=0.5,       # Casting frequency
            cast_width=1.0,      # Casting width
            bounds=self.bounds
        )
    ...
    def publish_velocity(self, velocity=None):
        ...
        position_target.position.z = 2.0  # Fixed altitude
